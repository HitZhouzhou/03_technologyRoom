...
def play(strategy0, strategy1, update,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    # print("测试: stratege0= %d" % strategy0())
    # while score0 < 100 and score1 < 100:
    #
    #     if who == 0:
    #         who=1
    #         score0 = simple_update(strategy0(), score0, score1, dice)
    #         if update is square_update:
    #             score0 = square_update(strategy0(), score0, score1, dice)
    #
    #     else:
    #         who=0
    #         score1 = simple_update(strategy1(), score1, score0, dice)
    #         if update is square_update:
    #             score1 = square_update(strategy1(), score1, score0, dice)
    while score0 < goal and score1 < goal:
        if who == 0:
            num_rolls = strategy0(score0, score1)
            if update is square_update:
                score0=square_update(num_rolls,score0,score1,dice)
            else:
                score0 += take_turn(num_rolls, score1, dice) # include tail and simple

            who = other(who)
        else:
            num_rolls = strategy1(score1, score0)
            if update is square_update:
                score1=square_update(num_rolls,score1,score0,dice)
            else:
